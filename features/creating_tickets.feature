Feature: Creating Tickets
  In order to create tickests for projects
  As a user
  ...
  Scenario: Description must be longer than 10 characters
    When I fill in "Title" with "Non-standards complance"
  ...
  @javascript
  Scenario: Creating a ticket with an attechment
    When I fill in "Title" with "Add documentation for blink tag"
    And I fill in "Description" with "The blank tag has undocumented speed attribute"
